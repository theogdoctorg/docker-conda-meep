...
RUN conda create --name mp -c conda-forge matplotlib spyder jupyter numpy scipy pymeep pymeep-extras -y
...
RUN conda create -n pmp -c conda-forge matplotlib spyder jupyter numpy scipy pymeep=*=mpi_mpich_* -y
